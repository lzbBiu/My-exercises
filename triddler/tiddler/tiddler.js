...
Q.enableSound();	
Quintus({ audioSupported: [ 'wav','mp3' ] });
Q.gravityX = 0;
Q.gravityY = 0;
...
Q.load('bgm.mp3,click.mp3,ui.mp3,bg.jpg,index.jpg,BigStone1.png,BigStone2.png,BigStone3.png,BigStone4.png,bright.png,flower.png,Lotus1.png,Lotus2.png,Lotus3.png,Lotus4.png,ripple.png,shark.png,tiddler.png,wall.png',function(){
	Q.sheet("shark",
        "shark.png",{
			cols: 13,
			tilew: 179, 
